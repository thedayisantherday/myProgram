...
public abstract class RequestUtil extends CallBack{
    ...
    //是否显示默认的toast
    private boolean isDefaultToast = true;
...
//    }
    ...
    public void post(final String url, final Map<String, String> map_params){
        ...
        if (NetUtils.isNetworkAvailable(mContext)) {
            mHttpUtils.send(HttpRequest.HttpMethod.POST, url, params,
                    new RequestCallBack<String>() {
                        ...
                        public void onFailure(HttpException error, String msg) {
                            ...
                            if (isDefaultToast){
                                Tools.showToast(mContext.getString(R.string.str_net_abnormal));
                            }
            ...
            if (isDefaultToast){
                Tools.showToast(mContext.getString(R.string.str_net_unusable));
            }
        }
    }
